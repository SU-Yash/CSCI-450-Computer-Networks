...
#define MYPORT "30255"	// the port users will be connecting to
...
int main(void)
{
	...
	if ((rv2 = getaddrinfo("localhost", "32255", &hints2, &servinfo2)) != 0) {
		fprintf(stderr, "getaddrinfo: %s\n", gai_strerror(rv2));
		return 1;
	}
	...
	if ((numbytes2 = sendto(sockfd2, answer, strlen(answer), 0,
